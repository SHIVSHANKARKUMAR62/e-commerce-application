...
class CategoriesProduct extends StatefulWidget {
  final String? name;
  const CategoriesProduct({Key? key,required this.name}) : super(key: key);
...
class _CategoriesProductState extends State<CategoriesProduct> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: FirebaseFirestore.instance.collection('products').where("categoryName",isEqualTo: widget.name).get(),
