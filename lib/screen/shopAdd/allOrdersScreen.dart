                  ...
                  return StreamBuilder(
                    ...
                    builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                      ...
                      if (snapshot.data != null) {
                        ...
                        //   quantity = int.parse(snapshot.data!.docs.get['productTotalPrice'] as String);
                        // }
                        ...
                        return Column(
                          children: [
                            ListTile(
                              ...
                              trailing: Text(snapshot.data!.docs.length.toString(),style: TextStyle(fontSize: Get.width*0.05)),
                            ),
                            ListView.builder(
                              itemCount: snapshot.data!.docs.length,
                              shrinkWrap: true,
