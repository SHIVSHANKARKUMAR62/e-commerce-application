import 'package:admineccomerce/screen/shopAdd/editProduct.dart';
...
class ProductPartAdmin extends StatefulWidget {
  final String id;
  const ProductPartAdmin({Key? key,required this.id}) : super(key: key);

  @override
  State<ProductPartAdmin> createState() => _ProductPartAdminState();
}

class _ProductPartAdminState extends State<ProductPartAdmin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Your Product")),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('products').where('userUid', isEqualTo: widget.id).snapshots(),
                          ...
                          Row(
                            ...
                            children: [
                              IconButton(onPressed: (){
                                Get.to(()=>EditProduct(productModel: productModel,id: id,));
